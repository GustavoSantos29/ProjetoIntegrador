    ...
    function cancelExcluir() {
      ...
      return (
        <div className="animal-list-container" >
          ...
          {
            isAdmin &&
            <Button type="sumit" children='Gerenciar animáis' className="button-create" onClick={() => console.log()} />
            }
          <Button type="sumit" children='Criar novo usuário' className="button-create" onClick={() => console.log()} />
            </div>
          {users.map((user) => (
            <Dropdown 
                key={user.id} 
